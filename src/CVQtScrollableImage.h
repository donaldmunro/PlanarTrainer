...
//   }
   ...
   void set_left_click_callback(std::function<void(cv::Point2f&, bool, bool, bool)>& callback) { on_left_click = callback; }
   void set_right_click_callback(std::function<void(cv::Point2f&, bool, bool, bool)>& callback) { on_right_click = callback; }
...
private:
   ...
   std::function<void(cv::Point2f&, bool, bool, bool)> on_left_click, on_right_click;
